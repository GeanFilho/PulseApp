...
function getDemoFeedbacks(count = 5) {
  const demoFeedbacks = [
    ...
    { 
      ...
      performance: 8,
      support: 'Sim',
      positiveEvent: 'Fechamos um grande contrato com um novo cliente.',
    ...
    { 
      ...
      performance: 7,
      support: 'Em partes',
      positiveEvent: 'Implementamos o novo sistema financeiro sem problemas.',
    ...
    { 
      ...
      performance: 9,
      support: 'Sim',
      positiveEvent: 'Lançamos a nova versão do produto com features muito esperadas pelos clientes.',
    ...
    { 
      ...
      performance: 8,
      support: 'Sim',
      positiveEvent: 'Finalizamos o redesign do site e recebemos comentários muito positivos.',
      improvementSuggestion: 'Precisamos de mais tempo para pesquisa de usuários.'
    },
    { 
      id: 10, 
